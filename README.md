...
- *Some games don't run correctly with the default settings, they won't launch at all or they require an analog stick. This list can be found on the [Compatibility Page](../main/Compatibility.md).*
